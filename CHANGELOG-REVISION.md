...
| `[tag]`, `[SHA]`, `[Zenodo DOI -- to be assigned]`, `[registry/image@sha256:digest]` | Removed. The Data availability section now describes what the repository contains and under what licence, without naming an artefact that does not yet exist. |
